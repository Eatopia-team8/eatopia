...
public enum ProductErrorCode implements ErrorCode {
    ...
    PRD_OUT_OF_STOCK(HttpStatus.BAD_REQUEST, "PRD-007", "상품의 재고가 부족합니다."),
    PRD_NOT_FOUND(HttpStatus.NOT_FOUND, "PRD-008", "존재하지 않는 상품입니다."),
    PRD_INVALID_ORDER_QUANTITY(HttpStatus.BAD_REQUEST, "PRD-009", "주문 수량이 올바르지 않습니다.");
